...
export type ExperiencePositionItemType = {
  ...
  employmentPeriod: {
    ...
    /** Use when an exact date is unavailable or intentionally omitted. */
    label?: string
  }
      ...
      <div className="not-prose flex items-center gap-3">
        ...
        <h3 className="text-lg leading-snug font-semibold">
          {experience.companyWebsite ? (
            <a
              className="rounded-sm link focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
...
export function ExperiencePositionItem({
  ...
  const { start, end, label } = position.employmentPeriod
  const isOngoing = !end
    ...
    >
      <CollapsibleTrigger
        className={cn(
          ...
          "focus-visible:rounded-lg focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background data-disabled:before:content-none"
        )}
      >
